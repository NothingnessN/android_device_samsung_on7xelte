...
TARGET_KERNEL_USE_LLVM := false

# Kernel arch
TARGET_KERNEL_ARCH := arm64
TARGET_KERNEL_HEADER_ARCH := arm

# Cross compile prefix (64-bit)
TARGET_KERNEL_CROSS_COMPILE := aarch64-linux-android-

# Cross compile prefix (32-bit compat)
TARGET_KERNEL_CROSS_COMPILE_ARM32 := arm-linux-androideabi-

# GCC toolchains
KERNEL_TOOLCHAIN := $(shell pwd)/prebuilts/gcc/$(HOST_OS)-x86/aarch64/aarch64-linux-android-4.9/bin
KERNEL_TOOLCHAIN_32 := $(shell pwd)/prebuilts/gcc/$(HOST_OS)-x86/arm/arm-linux-androideabi-4.9/bin
